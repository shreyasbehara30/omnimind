...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        setError(null);
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                email,
                password
            });
    ...
    const handleOAuthLogin = async (provider)=>{
        setLoading(true);
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithOAuth({
                provider,
                options: {
...
//# sourceMappingURL=frontend_51973087._.js.map