...
function ProfilePage() {
        ...
        "ProfilePage.useEffect": ()=>{
            const getUser = {
                "ProfilePage.useEffect.getUser": async ()=>{
                    const { data: { user }, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getUser();
                    if (error || !user) {
                        router.push('/login');
                        return;
                    }
    ...
    const handleSignOut = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signOut();
            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Signed out successfully');
            router.push('/login');
            router.refresh(); // Update server components/navbar
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Error signing out');
        }
    };
    if (loading) {
...
_s(ProfilePage, "8ZNwZiIFW44agV5SnSYwOiBYxdY=", false, function() {
    return [
...
//# sourceMappingURL=frontend_5f74cbcb._.js.map