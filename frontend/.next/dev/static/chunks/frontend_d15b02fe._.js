...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        setError(null);
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                email,
                password
            });
...
//# sourceMappingURL=frontend_d15b02fe._.js.map